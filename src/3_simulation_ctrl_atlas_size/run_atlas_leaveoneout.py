...
parser.add_argument("remove_study",
                    type=str,
                    help="ID of study to remove")
...
remove_study = args.remove_study
...
if args.oor_ct_oi:
    sim_id = f"leaveoneout_atlas_queryBatchdataset_id{query_dataset}_seed{split_seed}_remove{remove_study}_removeby{ct_oi[0]}_withOOR/"
else:
    sim_id = f"leaveoneout_atlas_queryBatchdataset_id{query_dataset}_seed{split_seed}_remove{remove_study}_removeby{ct_oi[0]}/"    
