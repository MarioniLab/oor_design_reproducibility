...
for p in $(cat /lustre/scratch126/cellgen/team205/ed6/PBMC_CZI_integration_filtered/PBMC_merged.normal.subsample500cells.clean_celltypes.txt); do
    ...
    echo "python run_oor_design_v2.py PBMC_merged.normal.subsample500cells.clean_celltypes.h5ad ${p} ${d} --outpath ${outdir}" | \
...
# for p in $(cat /lustre/scratch126/cellgen/team205/ed6/PBMC_CZI_integration_filtered/tmp/PBMC_merged.normal.subsample1000cells.clean_celltypes.txt); do
#     for d in ACR CR; do
